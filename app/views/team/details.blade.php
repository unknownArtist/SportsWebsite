    ...
    <div style="color:red" class="">
        {{ Session::get('errors') }}
                ...
                <div class="section-title">
                 <h4>Team Name<br /><span class="spancolor margin-left0"> </span></h4>
                 </div>
                  <div class="section-title">
                 <h4>Team Rink <br /><span class="spancolor margin-left0"></span></h4>
                  </div>
                   <div class="section-title">
                  <h4>Founded <br /><span class="spancolor margin-left0"></span></h4>
                  </div>
                  
                  <div class="btn-group updatebtnwidth">
                    <a href="{{URL::to('teams/list')}}" class="btn btn-mini" alt="Edit">
                ...
                <h4 style="margin-left:30px;">President Name:<br /><span class="spancolor"></span></h4>
                </div>   
                
                <div class="col-xs-12 colorh3 statistic-box well well-black padding-bottom15 margin-top15">
                
                <h4 style="margin-left:30px;">Assistant Coach:<h4><br/><span class="spancolor"> </span>
                
                </div>    
                
                <div class="col-xs-12 colorh3 statistic-box well well-black padding-bottom15 margin-top15">
                
                <h4 style="margin-left:30px;">Head Coach:<h4><br/><span class="spancolor"> </span>
                
                </div>  
                
                 <div class="col-xs-12 colorh3 statistic-box well well-black padding-bottom15 margin-top15">
                
                <h4 style="margin-left:30px;">History:<h4><br/><span class="spancolor"> </span>
